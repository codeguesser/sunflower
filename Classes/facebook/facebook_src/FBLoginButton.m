...
- (UIImage*)buttonImage {
  if (_session.isConnected) {
    return [UIImage imageNamed:@"845.png"];
  } else {
    if (_style == FBLoginButtonStyleNormal) {
      return [UIImage imageNamed:@"712.png"];
    } else if (_style == FBLoginButtonStyleWide) {
      return [UIImage imageNamed:@"794.png"];
    } else {
      return nil;
    }
  }
...
- (UIImage*)buttonHighlightedImage {
  if (_session.isConnected) {
    return [UIImage imageNamed:@"846.png"];
  } else {
    if (_style == FBLoginButtonStyleNormal) {
      return [UIImage imageNamed:@"713.png"];
    } else if (_style == FBLoginButtonStyleWide) {
      return [UIImage imageNamed:@"795.png"];
    } else {
      return nil;
    }
  }
